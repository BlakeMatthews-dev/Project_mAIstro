...
export const PLUGIN_MANIFEST_FILENAME = "maistro.plugin.json";
...
// package.json "maistro" metadata (used for onboarding/catalog)
...
export type MaistroPackageManifest = {
  extensions?: string[];
...
export type PackageManifest = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MaistroPackageManifest>>;

export function getPackageManifestMetadata(
  manifest: PackageManifest | undefined,
): MaistroPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
